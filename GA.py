...
class GA(object):
      ...
      def domutation(self, gene):
            ...
            while i<j:
                  ...
                  i+=1
                  j>>1
            newGene = self.modify_circle(newGene)
      ...
      def next(self):
            ...
            self.generation += 1
            self.judge()
            self.best1.gene=self.modify_circle(self.best1.gene)
            do_best=self.modify_circle(self.domutation(self.best1.gene))
            push_best=self.modify_circle(self.pushmutation(self.best1.gene))
            newLives = []
